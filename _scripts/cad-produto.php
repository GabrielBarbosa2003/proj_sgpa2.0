...
<body>
  ...
  <main id="main">
    ...
    <div class="container" data-aos="fade-up">
        <form class="form" method="post" action="codigos/acao-produto.php">
            
            <label>Nome do Produto</label><br />
            <input class="input-text" type="text" name="nomeProd" /><br /><br /><br />
            
            <span style="color:red;">OBS: PARA NUMEROS DICIMAIS USEM " . " AO INVEZ DE  " , " </span><br /> <br />  
            <label>Preço de Venda</label><br />
            <input class="input-text" type="number" step="0.01" name="precVend" /><br /><br />
            
            <label>Custo de Produção</label><br />
            <input class="input-text" type="number" step="0.01" name="custProd" /><br /><br />
            
            <label>Quantidade Produzida</label><br />
            <input class="input-text" type="number" step="0.01" name="qtdProd" /><br /><br />
            
            <label>Quantidade Vendida</label><br />
            <input class="input-text" type="number" step="0.01" name="qtdVend" /><br /><br />
            
            
            <input class="submit" type="submit" name="btnCad" value="Cadastrar Produto" />
